...
function showQuestion() {
  ...
  output.push(`<style>
               .rectangle1 {
                 height: ${question.answer1.a}px;
                 width: ${question.answer1.b}px;
               }
               .rectangle2 {
                 height: ${question.answer2.a}px;
                 width: ${question.answer2.b}px;
               }
               .rectangle3 {
                 height: ${question.answer3.a}px;
                 width: ${question.answer3.b}px;
               }
               </style>`);
